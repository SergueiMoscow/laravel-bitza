...
<!-- Затемнение всей страницы при открытии окна -->
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            @include('bitza.contracts.form')
        </div>
    </div>
    <div class="content">
        <div class="search">
            <input class="{{ $classForInputText }}" type="text" id="search_contract" />
            <button id="editBtn" class="{{ $classForInputButton }}">+</button>
        </div>
        <div class="edit">
        </div>
        <div id="list_contract" class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @include('bitza.contracts.list')
        </div>
    </div>
</x-app-layout>
